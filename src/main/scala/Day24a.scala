object Day24a:
  ...
  def findShortestPath(valleyMap: ValleyMap): Int =
    val start: Position = Position(valleyMap.entrance, 0)
  ...
  def main(args: Array[String]): Unit =
    ...
    val result: Int = findShortestPath(valley)
    println(result)
